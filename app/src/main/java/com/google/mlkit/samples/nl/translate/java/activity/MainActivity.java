...
import com.google.mlkit.samples.nl.translate.java.utils.ConvertTextToSpeech;
...
////                    Locale locale = new Locale(sourceLanguage.getCode());
//                    textToSpeech.isLanguageAvailable(Locale.US);
//                }
//                textToSpeech.setLanguage(Locale.US);
////                Log.d("=======> Avbl Or Not ", String.valueOf(textToSpeech.isLanguageAvailable(Locale.US)));
//
//            }
//        });
...
//            speakOut(srcTextView);
//            textToSpeak();
//            String toSpeak = srcTextView.getText().toString();
//            Toast.makeText(getApplicationContext(), toSpeak, Toast.LENGTH_SHORT).show();
//            String[] sentences = toSpeak.split("\n|\\.(?!\\d)|(?<!\\d)\\.");
////            for(int i = 0; i < sentences.length; i++){
////                textToSpeech.speak(sentences[i],TextToSpeech.QUEUE_FLUSH, null,"");
//            textToSpeech.speak(toSpeak, TextToSpeech.QUEUE_FLUSH, null, "");
//            if (!textToSpeech.isSpeaking()) {
//                Log.d("=====================>", "In If Condition, IsSpeaking True");
