...
public class ADCLBAppLoadAds {
    ...
    public void loadInterstitialAds(final Activity context) {
        if (MyApplication.getAdModel().getAdsInterstitial().equalsIgnoreCase("Google") || !MyApplication.getAdModel().getAdsInterstitialId().equalsIgnoreCase("None")) {
            loadAdMobInterstitialAds(context);
        }
    }

    public void loadBanner(final Activity activity, final LinearLayout linearLayout) {
        if (MyApplication.getAdModel().getAdsBanner().equalsIgnoreCase("Google") && !MyApplication.getAdModel().getAdsBannerId().equalsIgnoreCase("None")) {
    ...
    public void loadAdMobInterstitialAds(final Activity context) {
        if (appInterstitial == null && !appInterAdLoading && !MyApplication.getAdModel().getAdsInterstitialId().equalsIgnoreCase("None")) {
                ...
                public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                    ...
                    appInterstitial.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdDismissedFullScreenContent() {
                            ...
                            if (MyApplication.getAdModel().getAdsInterstitial().equalsIgnoreCase("Google")) {
                                loadAdMobInterstitialAds(context);
                            }
                            if (appCallback != null) {
    ...
    public void displayBottomAdsAds(Activity activity, FrameLayout frameViewAds, String showMedia) {
        if (MyApplication.getAdModel().getAdsNative().equalsIgnoreCase("Google") && !MyApplication.getAdModel().getAdsNativeId().equalsIgnoreCase("None")) {
