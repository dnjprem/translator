...
import com.google.mlkit.samples.nl.translate.java.adapter.ConversationAdapter;
...
//        conversationList.add(new Conversation("en", "EN Hello No", "hi", "HI Hello", 0));
//        conversationList.add(new Conversation("gu", "GU Hello", "en", "EN Hello Hi", 1));
//        conversationList.add(new Conversation("ba", "BA Hello", "en", "en Hello By", 0));
//        conversationList.add(new Conversation("gu", "GU Hello Yes", "en", "EN Hello", 1));
