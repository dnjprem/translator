...
import com.voicetranslator.translate.languagetranslator.Ads.ADCLBEasyAES;
import com.voicetranslator.translate.languagetranslator.Ads.ADCLBModelAd;
import com.voicetranslator.translate.languagetranslator.MyApplication;
import com.voicetranslator.translate.languagetranslator.retrofitClient.ADCLBRetrofitClient;
...
//            intent.putExtra(Intent.EXTRA_TITLE,false);
//            startActivity(intent);
//            finish();
//        }
...
//                            model.setAdsAppOpen("Google");
    ...
    public void gotoSkip() {
        ...
        if (MyApplication.getAdModel().getAdsNativePreload().equalsIgnoreCase("Yes")) {
