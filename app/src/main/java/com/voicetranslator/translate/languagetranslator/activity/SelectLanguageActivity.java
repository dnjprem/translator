...
import com.voicetranslator.translate.languagetranslator.adapter.SelectLanguageAdapter;
import com.voicetranslator.translate.languagetranslator.listener.SelectLanguageClickListener;
import com.voicetranslator.translate.languagetranslator.model.SelectLanguage;
...
public class SelectLanguageActivity extends RootActivity implements SelectLanguageClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isFromApp = getIntent().getBooleanExtra(Intent.EXTRA_TITLE, false);

        if (preference.getBoolean("isSelectLanguageOpenFirstTime", false) && !isFromApp) {
